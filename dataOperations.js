...
const paths = {
    ...
    "assignments": data => { 
        ...
        UIOps.loadTeacherAssignments(assignments, Auth.getCurrentUser()?.uid, 1);
...
export function loadTeacherData(teacherId) {
    UIOps.showLoading();
    onValue(ref(database, "assignments"), (snapshot) => {
        ...
        assignments = data 
            ...
            : [];
        UIOps.loadTeacherAssignments(assignments, teacherId, 1);
        UIOps.loadTeacherAnalytics(assignments, teacherId);
    }, { onlyOnce: true });
    UIOps.hideLoading();
}
